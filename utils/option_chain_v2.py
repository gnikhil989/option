"""
Option Chain Manager Module V2
...
class OptionChainManagerV2:
    ...
    def __init__(self, underlying, expiry, websocket_manager=None):
        """
        Initialize OptionChainManagerV2
        ...
        self.cache = OptionChainCacheV2()
        self.monitoring_active = False
        self.initialized = False
        self.manager_id = f"{underlying}_{expiry}_v2"
        self.option_mode = 'quote'  # Forced Quote Mode
        logger.info(f"Initialized OptionChainManagerV2 for {underlying} (Quote Mode Only)")
